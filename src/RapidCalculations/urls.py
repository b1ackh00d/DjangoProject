...
urlpatterns = [
    ...
    path('show_marks_targetCOStudent/', show_targetCOStudentmarks, name="show_marks_targetCOStudent"),
    path('show_marks_targetCOClass/', show_targetCOClassmarks, name="show_marks_targetCOClass"),
    ...
    path('add_marks_targetCOStudent/', add_targetCOStudentmarks, name="add_marks_targetCOStudent"),
    path('add_marks_targetCOClass/', add_targetCOClassmarks, name="add_marks_targetCOClass"),
    ...
    path('edit_marks_targetCOStudent/<pk>/', edit_marks_targetCOStudent, name='edit_marks_targetCOStudent'),
    path('edit_marks_targetCOClass/<pk>/', edit_marks_targetCOClass, name='edit_marks_targetCOClass'),
    ...
    path('delete_marks_targetCOStudent/<pk>/', del_marks_targetCOStudentmarks, name='del_marks_targetCOStudentmarks'),
    path('delete_marks_targetCOClass/<pk>/', del_marks_targetCOClassmarks, name='del_marks_targetCOClassmarks'),
